...
View.prototype.exercise4 = function () {
  ...
  $('.square:nth-child(even)').text('lisza');
...
View.prototype.exercise5 = function () {
  ...
  $('.square').on('click', (e) => { alert( $(e.currentTarget).attr("data-pos") ); });
};
...
View.prototype.exercise6 = function () {
  ...
  $('.square').each( (i, el) => { $(el).css("background-color", window._randomColorString()); })
  // why do we hav to use 'each' here? Why does forEach not work?
};
