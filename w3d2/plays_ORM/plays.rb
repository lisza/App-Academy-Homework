...
class Play
  ...
  def self.find_by_title(title)
    ...
    # We access it by .first because play is stored in an array.
    Play.new(play.first)
  end
  ...
  def self.find_by_playwright(name)
    ...
    # This is to return results as an array of Play objects?
...
class Playwright
  ...
  def self.find_by_name(name)
    ...
    # We check because our playwrights are stored in an array, so we
  ...
  # returns all plays written by playwright
  def get_plays
    all_plays = Plays.find_by_playwright(self.name)
  end
end
